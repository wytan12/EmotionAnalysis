  ...
  createBasicNotification(): void {
    if (!this.notificationShown) {
      this.notification.blank(
        'TAKE NOTE',
        '0-1 means weak, 1-2 means moderate, 2-3 means strong. <br> <br> User can hover and click on the graph points to see relevant notes. <br> <br> Click on the legend. To view “reading emotions” only, click on “read”. Click on “write” for writing emotions only. Click on the legend again to show all. <br> <br> If you see overlapping points, please select either “read” or “write” only in the legend to view more details. <br>',
        {
          nzStyle: {
            width: '600px',
            marginLeft: '-265px'
